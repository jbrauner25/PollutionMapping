...
filepaths = ['15-50-31.mat', '15-57-07.mat', '16-14-28.mat', '16-22-14.mat', '16-28-38.mat', '16-33-57.mat']
...
filtered_map1 = Kalman_Filter(map1, total_data1, None)
y_pred1 = []; var_pred1 = []
...
filtered_map2 = Kalman_Filter(map2, total_data2, None)
y_pred2 = []; var_pred2 = []
...
scipy.io.savemat('/Users/jaredbrauner/Documents/data/Pollution_Monitoring/PollutionMapping/FRF/training/2D/180720/training.mat',
